...
$storageEngine = new \Bitpay\Storage\EncryptedFilesystemStorage('MegaEffektiv'); // Password may need to be updated if you changed it
...
$token->setToken('Dk2x2h9fJ32SpXtHKgFSJbWo8rsd6zVoJrA8QMoa3j8U'); // UPDATE THIS VALUE
